...
namespace Cardinal
{
    internal class VectorTools
    {
        ...
        {
            float heading = MathEx.NormalizeRadian(3.14159265f / 2f + MathHelper.CalculateHeading(location,
                myLocation));
        ...
        {
            float heading = MathEx.NormalizeRadian(3.14159265f + MathHelper.CalculateHeading(location,
                myLocation));
        ...
        {
            float heading = MathEx.NormalizeRadian(MathHelper.CalculateHeading(location,
                myLocation));
        ...
        {
            float d = Math.Abs(MathEx.NormalizeRadian(characterHeading
